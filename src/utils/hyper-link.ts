...
function createNodePosition (node: undefined | t.Node) {
  if (!node) {
    return '';
  }
...
export function createFileLink (fileInfo: undefined | FileInfo, node?: t.Node) {
  if (!fileInfo) {
    return '';
  }
...
export function createFileUrl (fileInfo: undefined | FileInfo, node?: t.Node) {
  if (!fileInfo) {
    return '';
  }
